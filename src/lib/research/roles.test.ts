...
describe("research buyer role taxonomy", () => {
  ...
  it("calculates verified coverage and exposes missing role categories", () => {
    ...
    expect(coverage[0]).toMatchObject({
      ...
      // La cobertura se mide contra REQUIRED_ROLE_CATEGORIES: SAFETY cuenta
      // como contacto valido pero su ausencia no se reporta como faltante,
      // porque es el perfil mas escaso del corredor y no es requisito.
