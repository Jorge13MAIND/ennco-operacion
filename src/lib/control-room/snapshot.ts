...
export const INITIAL_MILESTONES: Milestone[] = [
  {
    ...
    gate: "EXTEND",
    dueDate: "2026-08-12",
    acceptance: "Paquete documental auditado; contrato confirmado por Jorge e identidades y dominios del Anexo A verificados. PASS depende del binding en base y los gates técnicos live.",
    evidence: [
    ...
    blocker: "Falta vincular el Anexo A en la base aislada y cerrar los gates técnicos live.",
    nextAction: "Cargar el snapshot 8e986eff en staging aislado y verificar la supresión transaccional.",
  ...
  },
  {
    ...
    blocker: "Modelo aprobado por Paco. El aviso requiere aprobación y los recibos requieren antivirus real.",
    nextAction: "Mantener release público cerrado hasta aprobar privacidad y validar Storage con antivirus.",
    updatedAt: UPDATED_AT,
  },
  {
    id: "M4",
  ...
  },
  {
    ...
    blocker: "Binding del Anexo A, legal, dominios, DNS, 42 días de warmup Apollo, canary live, cinco cuentas y aprobación explícita.",
