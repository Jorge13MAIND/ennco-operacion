...
export const INITIAL_MILESTONES: Milestone[] = [
  ...
  },
  {
    ...
    evidence: [
      ...
      "docs/21-final-acceptance-checklist.md",
    ],
    blocker: "M0 y M2 a M8 conservan gates live abiertos. Faltan UAT, capacitación, transferencia, restore live y aceptación ENNCO.",
    nextAction: "Congelar el commit y paquete fuente. Después conservar EVIDENCE_READY local y ejecutar los diez checks live.",
    updatedAt: UPDATED_AT,
  },
];
