...
insert into public.roadmap_milestones (
  ...
  ('11111111-1111-4111-8111-111111111111', 'M0', 'Readiness', 'Teckel Product & Engineering', 'IN_PROGRESS', '2026-08-13', 'M0 documentado y Anexo A hasheado.', 'Anexo A pendiente.', 'Importar Anexo A.'),
  ('11111111-1111-4111-8111-111111111111', 'M1', 'Control Tower y golden path', 'Teckel Product & Engineering', 'IN_PROGRESS', '2026-08-18', 'Golden path e idempotencia probados.', null, 'Ejecutar prueba SQL.'),
