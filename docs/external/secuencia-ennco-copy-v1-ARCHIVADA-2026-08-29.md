> **ARCHIVADA el 3-sep-2026.** Esta es la v1, con el molde de "golpe con la cifra".
> Quedó superada por el copy que Francisco Cuellar aprobó: la versión vigente es
> `secuencia-ennco-copy.md`. Se conserva por trazabilidad, NO se usa para enviar.
