...
Snapshot de autoridad: 11 de agosto de 2026, después de la delegación vinculante de AVA.

`R` ejecuta. `A` acepta y responde por una sola decisión. `C` es consultado. `I` es informado.

| Decisión o entrega | R | A | C | I | Estado de autoridad |
|---|---|---|---|---|---|
| Auditoría, arquitectura y modelo de datos local | Teckel Product & Engineering | AVA | QA independiente | Jorge | VERIFIED |
| UX, copy interno, contratos API y datos sintéticos | Teckel Product & Engineering | AVA | QA independiente | Jorge | VERIFIED |
| Corrección de fallas de gate interno | Teckel Product & Engineering | AVA | QA independiente | Jorge | VERIFIED |
| Staging aislado a 0%, no compartido y sin tráfico | Teckel Product & Engineering | AVA | QA independiente | Jorge | VERIFIED |
...
| Aceptación final del programa | Product Engineering | Francisco | Jorge, Paco, AVA y QA | Operador ENNCO | BLOCKED_EXTERNAL |

La delegación AVA no habilita contacto, compras, DNS, credenciales, publicación, producción ni compromisos comerciales. Ningún campo o silencio implica aprobación tácita.
